...
class mainCharacter extends BaseGameObject {
    ...
    getBoxBounds = function () {
        let bounds = {
            left: this.x + 20,//because of the wings
            right: this.x + this.width - 20, //because of the wings
            top: this.y + 30,
    ...
    update = function () {
        ...
        if (this.xVelocity === 0 && this.yVelocity === 0 && 
            this.animationData.firstSpriteIndex !== this.animationData.currentSpriteIndex) {
