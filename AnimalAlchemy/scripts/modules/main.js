...
import { MixedAnimal } from "../gameObjects/mixedAnimal.js";
...
function resetGame() {
    // Clear all game objects and reset any relevant global variables
    ...
    // Optionally, reset other states such as score, time, etc.
